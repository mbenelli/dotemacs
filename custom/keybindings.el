...
;; Basic movements customization for dvorak keyboard.
;;
;; TODO: some modes would need adaptation to this layout
;; look at spacemacs|evilify function!
;;
;; dired-mode
;;   evil-state is `normal' but there are conflicts with existings keybindings.
;; magit-status-mode (probably all magit-*-mode)
;;   evil-state is `emacs', so these keybindings don't work.
;;
